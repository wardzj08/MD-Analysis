...
input_file = r'D:/LAMMPSTraj/RoggeHbond/dump.2LoadHbondRogge.lammpstrj' # file to read trajectory from
#input_file = r'D:/LAMMPSTraj/RoggeHbond/dump.RoggeTraPPEHbond1Load1.lammpstrj' # file to read trajectory from
snapshots_to_read = 200 # Number of timesteps to read from traj file
...
loading = 2 #3.125 # level of loading  (diffusing molecules per primative cell)
...
Ace_O = 10 # 'Type' of acetone oxygen atom
#mu3OHBondDist = 1.2 # angstrom distance for the mu3OH bond
hydrogenBondDist = 2# Acetone-Hydrogen hydrogen bonding distance
